"use strict";
(self["webpackChunkfrontend"] = self["webpackChunkfrontend"] || []).push([["default-node_modules_angular_forms_fesm2022_forms_mjs"],{
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/common */ 8963);
/**
...
const NG_VALUE_ACCESSOR = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'NgValueAccessor' : '');
const CHECKBOX_VALUE_ACCESSOR = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => CheckboxControlValueAccessor),
  multi: true
};
...
const DEFAULT_VALUE_ACCESSOR = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => DefaultValueAccessor),
  multi: true
};
function _isAndroid() {
  const userAgent = (0,_angular_common__WEBPACK_IMPORTED_MODULE_8__.getDOM)() ? (0,_angular_common__WEBPACK_IMPORTED_MODULE_8__.getDOM)().getUserAgent() : '';
  return /android (\d+)/.test(userAgent.toLowerCase());
}
const COMPOSITION_BUFFER_MODE = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'CompositionEventMode' : '');
...
const NG_VALIDATORS = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'NgValidators' : '');
const NG_ASYNC_VALIDATORS = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'NgAsyncValidators' : '');
...
function toObservable(value) {
  const obs = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.isPromise)(value) ? (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.from)(value) : value;
  if ((typeof ngDevMode === 'undefined' || ngDevMode) && !(0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.isSubscribable)(obs)) {
    ...
    throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(-1101, errorMessage);
  }
  return obs;
}
...
function composeAsync(validators) {
  ...
  return function (control) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.forkJoin)(observables).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(mergeErrors));
  };
}
...
`;
const VERSION = /* @__PURE__ */new _angular_core__WEBPACK_IMPORTED_MODULE_2__.Version('21.2.13');
function controlParentException(nameOrIndex) {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1050, `formControlName must be used with a parent formGroup or formArray directive. You'll want to add a formGroup/formArray
...
function ngModelGroupException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1051, `formControlName cannot be used with an ngModelGroup parent. It is only compatible with parents
...
function missingFormException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1052, `formGroup expects a FormGroup instance. Please pass one in.
...
function groupParentException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1053, `formGroupName must be used with a parent formGroup directive.  You'll want to add a formGroup
...
function arrayParentException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1054, `formArrayName must be used with a parent formGroup directive.  You'll want to add a formGroup
      directive and pass it an existing FormGroup instance (you can create one in your class).
...
function assertControlPresent(parent, isGroup, key) {
  ...
  if (!collection.length) {
    throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1000, typeof ngDevMode === 'undefined' || ngDevMode ? noControlsError(isGroup) : '');
  }
  if (!controls[key]) {
    throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1001, typeof ngDevMode === 'undefined' || ngDevMode ? missingControlError(isGroup, key) : '');
  }
}
function assertAllValuesPresent(control, isGroup, value) {
  control._forEachChild((_, key) => {
    if (value[key] === undefined) {
      throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(-1002, typeof ngDevMode === 'undefined' || ngDevMode ? missingControlValueError(isGroup, key) : '');
    }
  });
}
class AbstractControl {
  ...
  statusReactive = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.signal)(undefined, ...(ngDevMode ? [{
  ...
  pristineReactive = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.signal)(true, ...(ngDevMode ? [{
  ...
  touchedReactive = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.signal)(false, ...(ngDevMode ? [{
...
const CALL_SET_DISABLED_STATE = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'CallSetDisabledState' : '', {
...
function _throwMissingValueAccessorError(dir) {
  ...
  throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(-1203, `No value accessor for form control ${loc}.`);
}
function _throwInvalidValueAccessorError(dir) {
  const loc = _describeControlLocation(dir);
  throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1200, `Value accessor was not provided as an array for form control with ${loc}. ` + `Check that the \`NG_VALUE_ACCESSOR\` token is configured as a \`multi: true\` provider.`);
}
...
const formDirectiveProvider$2 = {
  ...
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => NgForm)
};
...
class NgForm extends ControlContainer {
  ...
  submittedReactive = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.signal)(false, ...(ngDevMode ? [{
    debugName: "submittedReactive"
  }] : []));
  _directives = new Set();
  form;
  ngSubmit = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.EventEmitter();
  options;
...
function modelParentException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1350, `
...
function formGroupNameException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1351, `
...
function missingNameException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1352, `If ngModel is used within a form tag, either the name attribute must be set or the form
...
function modelGroupParentException() {
  return new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1353, `
...
const modelGroupProvider = {
  provide: ControlContainer,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => NgModelGroup)
};
...
const formControlBinding$1 = {
  provide: NgControl,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => NgModel)
};
...
class NgModel extends NgControl {
  ...
  model;
  options;
  update = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.EventEmitter();
  ...
  static ɵfac = function NgModel_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || NgModel)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ControlContainer, 9), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](NG_VALIDATORS, 10), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](NG_ASYNC_VALIDATORS, 10), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](NG_VALUE_ACCESSOR, 10), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectorRef, 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](CALL_SET_DISABLED_STATE, 8));
  };
  static ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({
    type: NgModel,
...
const NUMBER_VALUE_ACCESSOR = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => NumberValueAccessor),
  multi: true
};
...
function throwNameError() {
  throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1202, `
...
class RadioControlValueAccessor extends BuiltInControlValueAccessor {
  ...
  formControlName;
  value;
  callSetDisabledState = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.inject)(CALL_SET_DISABLED_STATE, {
    optional: true
...
const RANGE_VALUE_ACCESSOR = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => RangeValueAccessor),
  multi: true
};
...
class AbstractFormDirective extends ControlContainer {
  ...
  _submittedReactive = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.signal)(false, ...(ngDevMode ? [{
...
const formDirectiveProvider$1 = {
  provide: ControlContainer,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => FormArrayDirective)
};
...
const NG_MODEL_WITH_FORM_CONTROL_WARNING = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'NgModelWithFormControlWarning' : '');
const formControlBinding = {
  provide: NgControl,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => FormControlDirective)
};
...
const formGroupNameProvider = {
  provide: ControlContainer,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => FormGroupName)
};
...
const formArrayNameProvider = {
  provide: ControlContainer,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => FormArrayName)
};
...
const controlNameBinding = {
  provide: NgControl,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => FormControlName)
};
...
const formDirectiveProvider = {
  provide: ControlContainer,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => FormGroupDirective)
};
...
const SELECT_VALUE_ACCESSOR = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => SelectControlValueAccessor),
  multi: true
};
...
class SelectControlValueAccessor extends BuiltInControlValueAccessor {
  ...
  set compareWith(fn) {
    if (typeof fn !== 'function' && (typeof ngDevMode === 'undefined' || ngDevMode)) {
      throw new _angular_core__WEBPACK_IMPORTED_MODULE_2__.RuntimeError(1201, `compareWith must be a function, but received ${JSON.stringify(fn)}`);
    }
    this._compareWith = fn;
  }
  _compareWith = Object.is;
  appRefInjector = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.ApplicationRef).injector;
  destroyRef = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_2__.DestroyRef);
  cdr = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectorRef);
  _queuedWrite = false;
...
const SELECT_MULTIPLE_VALUE_ACCESSOR = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => SelectMultipleControlValueAccessor),
  multi: true
};
...
const REQUIRED_VALIDATOR = {
  provide: NG_VALIDATORS,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => RequiredValidator),
  multi: true
};
const CHECKBOX_REQUIRED_VALIDATOR = {
  provide: NG_VALIDATORS,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => CheckboxRequiredValidator),
  multi: true
};
...
const EMAIL_VALIDATOR = {
  provide: NG_VALIDATORS,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => EmailValidator),
  multi: true
};
...
const MIN_LENGTH_VALIDATOR = {
  provide: NG_VALIDATORS,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => MinLengthValidator),
  multi: true
};
...
const MAX_LENGTH_VALIDATOR = {
  provide: NG_VALIDATORS,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => MaxLengthValidator),
  multi: true
};
...
const PATTERN_VALIDATOR = {
  provide: NG_VALIDATORS,
  useExisting: (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.forwardRef)(() => PatternValidator),
  multi: true
};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__.setClassMetadata(NonNullableFormBuilder, [{
    ...
    args: [{
      providedIn: 'root',
      useFactory: () => (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.inject)(FormBuilder).nonNullable
    }]
  }], null, null);
})();
